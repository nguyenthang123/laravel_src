...
$(document).ready(function(){
    ...
    if(domain=='phongkhambenhxahoi.vn'){
        flag='1';
        str='<link rel="stylesheet" href="//cdn-alo.coccoc.com/widget/css/widget.css"/><script type="text/javascript">var widget_token="91051c4b07557b7034465f2f676231eb281aea78";</script><script type="text/javascript" src="//cdn-alo.coccoc.com/widget/js/widget.js"></script>';
    }else if(domain=='trihanoi.com'){
        flag='1';
        str='<link rel="stylesheet" href="//cdn-alo.coccoc.com/widget/css/widget.css"/><script type="text/javascript">var widget_token="9e566fece06aacc64f539eb5356d63f749274f92";</script><script type="text/javascript" src="//cdn-alo.coccoc.com/widget/js/widget.js"></script>';
    }else if(domain=='khamnamkhoahanoi.vn'){
        flag='1';
        str='<link rel="stylesheet" href="//cdn-alo.coccoc.com/widget/css/widget.css"/><script type="text/javascript">var widget_token="86f28e5da467e1292959c195b4d5971d7aed6741";</script><script type="text/javascript" src="//cdn-alo.coccoc.com/widget/js/widget.js"></script>';
    }else if(domain=='taimuihonghanoi.net'){
        flag='1';
        str='<link rel="stylesheet" href="//cdn-alo.coccoc.com/widget/css/widget.css"/><script type="text/javascript">var widget_token="0bcd850b2756d950bfe568cd051b7e49e284cd09";</script><script type="text/javascript" src="//cdn-alo.coccoc.com/widget/js/widget.js"></script>';
    }else if(domain=='benhtri168.com'){
        flag='1';
        str='<link rel="stylesheet" href="//cdn-alo.coccoc.com/widget/css/widget.css"/><sc'+'ript type="text/javascript">var widget_token="0bcd850b2756d950bfe568cd051b7e49e284cd09";</scr'+'ipt><scr'+'ipt type="text/javascript" src="//cdn-alo.coccoc.com/widget/js/widget.js"></scr'+'ipt>';
    }
    if(flag=='2'){
        document.write(str);
        //return str;
        ...
        document.writeln("<style>" +
            ...
            ".dangkysdt:hover .fp-ph-img-circle{background: #baf5a7 url(http://trihanoi.com/dangkysdt/images/ico_dienthoai.gif) no-repeat center center;background-size: 70%;}" +
            ...
            ".popup_dangkysdt_ct{display: inline-block;background: #ffffff;border-radius: 20px;margin: auto;padding: 60px 75px;position: relative;top: 80px;z-index: 200001;}" +
...
//document.writeln("<div class='dangkysdt' id='dangkysdt'><p>Click Ngay</p><div class='fp-ph-circle'></div><div class='fp-ph-circle-fill'></div><div class='fp-ph-img-circle'></div></div><div id='popup_dangkysdt'><div class='popup_dangkysdt_ct'><span class='popup_dangkysdt_close'></span><label>Nhập số điện thoại của Bạn và Bác sỹ sẽ gọi lại sau 36 giây!</label><form name='popup_dangkysdt'><div class='input'><input type='text' name='dienthoai' onfocus="(this.value == 'Nhập số điện thoại') && (this.value = '')" onblur="(this.value == '') && (this.value = 'Nhập số điện thoại')" onkeypress='return event.charCode >= 48 &amp;&amp; event.charCode <= 57'  maxlength='13'></div></form><button type='button' class='popup_dangkysdt_dangky'>Click để được gọi lại!</button></div></div>");
        ...
        var str_html2='<div id="popup_dangkysdt">' +
            ...
            '<div class="popup_dangkysdt_tb" style="display:none;"><p><img src="http://trihanoi.com/dangkysdt/images/ok.png"></p><p>Yêu cầu gọi lại đã được gửi đến bác sỹ, mong bạn nhẫn nại chờ đợi!</p></div>'+
            '<div class="popup_dangkysdt_ct">' +
            '<span class="popup_dangkysdt_close">' +
            '</span><label>Nhập số điện thoại của bạn tại đây để Bác sỹ chủ động liên lạc với bạn!</label>' +
            '<form name="popup_dangkysdt">' +
            '<div class="input">' +
            ...
            '<button type="button" class="popup_dangkysdt_dangky">Click để được gọi lại'+'</button>' +
            '</div></div>';
        var str3=str_html+str_html2;
                ...
                if(dienthoai=="" || dienthoai=='undifined'){
                    ...
                    if(checkmobile==0){
                        ...
                        setTimeout(function(){
                            ...
                            var link_dangky="http://phongkhamgiaiphong.com/dangky.php?hoten="+hoten+'&dienthoai='+dienthoai+'&uri='+url;
