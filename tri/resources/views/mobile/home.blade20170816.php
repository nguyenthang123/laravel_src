    ...
    <div class="main_item hangmuc">
        <div class="hangmuc_item">
            <a href="/tri">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_tri.png" alt="tri">
                </div>
                <p>Trĩ</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/nut-ke-hau-mon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_nutkehaumon.png" alt="nut ke hau mon">
                </div>
                <p>Nứt kẽ hậu môn</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/ro-hau-mon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_rohaumon.png" alt="ro hau mon">
                </div>
        ...
        <div class="hangmuc_item">
            <a href="/tao-bon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_taobon.png" alt="Tao bon">
                </div>
                <p>Táo bón</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/dai-tien-ra-mau">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_daitienramau.png" alt="Dai tien ra mau">
                </div>
        ...
        <div class="hangmuc_item">
            <a href="/ap-xe-hau-mon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_apxehaumon.png" alt="Ap xe hau mon">
                </div>
                <p>Áp xe hậu môn</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/ngua-hau-mon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_nguahaumon.png" alt="ngua hau mon">
                </div>
                <p>Ngứa hậu môn</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/eczema-hau-mon">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_eczema.png" alt="eczema">
                </div>
                <p>Eczema hậu môn</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="<?= link_tuvan;?>">
                <div class="hangmuc_item_img">
                    <img src="/public/mobile/imgs/ico_hm_tck.png" alt="trieu chung khac">
                </div>
