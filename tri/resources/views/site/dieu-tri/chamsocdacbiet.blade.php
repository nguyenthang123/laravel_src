...
<div id="main1">
    ...
    <div class="main1-r">
        <div class="expert-list-banner" id="expert-list-banner">
            <a  href="">
                <img src="http://trihanoi.com/public/images/khai/hoat_dong_cong_ich/neiye_gg.jpg"/>
            </a>
        </div>
        ...
        <div class="service">
            ...
            <div class="service-r">
                <dl>
                    <dd>
                        <div class="service-r1">làm nổi bật giá trị</div>
                        <div class="service-r2">cảm nhận sự nhiệt tình,<br>tốt mà không đắt</div>
                        <div class="pv_tt">
                            <div class="pv_tt1"><b style="line-height: 18px;display: block;padding-top: 7px;">Phục<br>vụ</b></div>
                            <div class="pv_tt2"><b style="line-height: 18px;display: block;padding-top: 7px;">Tận<br>tình</b></div>
                        </div>
                    </dd>
                    <div style="width: 100%;height: 30px;overflow: hidden;"></div>
                    <dt>Phòng khám trực tràng hậu môn Giải Phóng trở thành thương hiệu phòng khám có sức ảnh hưởng lớn, dẫn đầu trong một thời gian dài về thái độ chăm sóc nhiệt tình chu đáo với bệnh nhân.</dt>
                </dl>
            </div>
        </div>
    </div>
