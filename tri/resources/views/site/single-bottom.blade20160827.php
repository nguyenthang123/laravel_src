	<div class="tuvanbasy" style="margin: 0;    background: #4f402b;
         color: #ffffff;
         ...
         height: 35px;
         line-height: 35px;
             margin-bottom: 15px;">không có nội dung bạn cần,hãy <a style="    color: #ffffff;
         font-size: 13px;" href="http://chat.phongkham168.com/LR/Chatpre.aspx?id=KRX41100266&amp;lng=en">tư vấn trực tiếp</a> với bác sỹ &gt;&gt;&gt;&gt;&gt; 
      </div>
      <div class="row timhieubenh" style="     overflow: hidden;
    padding-left: 14px;
    padding-right: 5px;">
         <div class="col-lg-4">
            <a href="http://chat.phongkham168.com/LR/Chatpre.aspx?id=KRX41100266&amp;lng=en" class="btn" style="background: #95713f;"><img src="http://phukhoa168.com/public/frontend/img/detail/ico_bs.png">tìm hiểu bệnh</a>
         </div>
         <div class="col-lg-4">
            <a href="http://chat.phongkham168.com/LR/Chatpre.aspx?id=KRX41100266&amp;lng=en" class="btn" style="background: #d7aa6c;"><img src="http://phukhoa168.com/public/frontend/img/detail/dola.png">tư vấn chi phí</a>
         </div>
         <div class="col-lg-4">
            <a href="http://chat.phongkham168.com/LR/Chatpre.aspx?id=KRX41100266&amp;lng=en" class="btn" style="background: #a12a35;"><img src="http://phukhoa168.com/public/frontend/img/detail/ico_tv.png">bác sỹ tư vấn</a>
         </div>
      </div>
