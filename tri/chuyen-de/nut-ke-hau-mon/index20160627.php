                    ...
                    <div class="col-sm-9 col-md-9">
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md-3 no_mar_pad">
                                ...
                                <p>Tiêu chuẩn phục hồi PAC, hồi phục nhanh</p>
                            </div>
                            <div class="col-sm-3 col-md-3 no_mar_pad">
                                <img src="images/no1_tk3.jpg">
                                <p>quá trình điều trị ít đau đớn, an toàn, hiệu quả</p>
                            </div>
                            <div class="col-sm-3 col-md-3 no_mar_pad">
                                <img src="images/no1_tk4.jpg">
                                <p>rút ngắn thời gian điều trị, tiết kiệm chi phí</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-3">
                ...
                <div class="row">
                    <div class="col-sm-9 col-md-9" style="width: 685px;">
                        <div class="row no2_utkt">
                            ...
                            <span>Độ kiểm soát tốt, không than hóa, không đóng vảy, mạch máu khép kín. rút ngắn thời gian thủ thuật, hiệu quả : vết thương hoại tử, khô lại, đóng vảy và bong ra.</span>
                        </div>
                        <div class="row no2_kttt">
                            ...
                            <p class="kttt_text kttt_text3">
                                sau thủ thuật vết thương giúp dễ hồi phục, không ảnh hưởng tới chức năng bình thường của hậu môn.
                            </p>
                            <p class="kttt_text kttt_text4">
                                Trong thời gian ngắn đạt được hiệu quả hài lòng: vùng bệnh bị hoại tử, đóng vảy, bong ra.
                            </p>
                            <p class="kttt_text kttt_text5">
                                thời gian thủ thuật ngắn, trong quá trình thủ thuật tiến hành gây mê hoặc gây tê cục bộ, người bệnh sẽ ít đau hơn.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row" style="background-color: white;">
                    ...
                    <div class="col-lg-3">
                        <div class="phucvu_content">
                            ...
                            <p>
                                Quá trình chẩn đoán điều trị tiêu chuẩn quy phạm, sau thủ thuật điều chỉnh phương án khoa học có hiệu quả, phục hồi nhanh.
                            </p>
                        </div>
                    </div>
                </div>
