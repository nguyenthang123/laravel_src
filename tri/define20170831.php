...
<li class="menu_lv1" id="menu_lienquan">
    ...
    <div class="lien_quan menu_content menu_lienquan_content" style="width: 20%;position: absolute;">
        <ul>
            ...
            <li><a href="'.link_diachi.'"><img src="/public/frontend/home/image/menu/ico_pk_dc.png" alt="Địa chỉ">Địa chỉ phòng khám</a></li>
        </ul>
    </div>
</li>
...
function cd_footer(){
    $str='<link rel="stylesheet" type="text/css" href="/public/frontend/home/css/footer.css">';
    $str.='<footer>
    <div class="container">
