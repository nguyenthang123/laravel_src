...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    //Bình luận
    Route::any('/binhluan/index', 'Admin\BinhluanController@index');
    Route::any('/binhluan/add', 'Admin\BinhluanController@add');
    Route::post('/binhluan/add', 'Admin\BinhluanController@postadd');
    Route::any('/binhluan/edit/{id?}', 'Admin\BinhluanController@edit');
    Route::any('/binhluan/update/{id?}', 'Admin\BinhluanController@update');
    Route::any('/binhluan/del/{id?}', 'Admin\BinhluanController@del');
...
Route::get('search/{search_site?}', 'Site\SanphamController@get_search_site');
Route::post('search/{search_site?}', 'Site\SanphamController@search_site');
