$(document).ready(function(){
    $(".nav2_box").mouseover(function(){
        $(".nav2_box").stop().animate({"width":"125px"},{easing: 'easeOutQuad',duration:200});
        $(".nav2_box").find(".tit").stop().animate({"width":"125px"},{easing: 'easeOutQuad',duration:200});
        $(this).stop().animate({"width":"370px"});
        $(this).find(".tit").stop().animate({"width":"123px"},{easing: 'easeOutQuad',duration:200});
    });
    slides();
    /*hot_box*/
    var _hotIndex=0;
...
$(document).ready(function ($) {
    ...
    $("#dangkykham").bind("click", function () {
        $("#frmdkk").submit();
    });
});
