<link rel="stylesheet" type="text/css" href="<?= fixk;?>/public/frontend/home/css/global.css">
<link rel="stylesheet" type="text/css" href="<?= fixk;?>/public/frontend/home/css/footer.css">
<footer>
    <div class="container">
        <div class="flex flex1 justify-content-between">
            <div class="flex1col1">
                <h2>
                    <a href="<?= domain;?>">
                        <img src="<?= fixk;?>/public/frontend/home/image/logo.png" alt="" class="center-block">
                    </a>
                </h2>
            ...
            <div class="flex1col2">
                ...
                <ul>
                    ...
                    <li><h5 class="text-uppercase"><a href="#">Trường hợp khỏi bệnh</a></h5></li>
            ...
            <div class="flex1col2">
                ...
                <ul>
                    ...
                    <li><h5 class="text-uppercase"><a href="/<?= cat_rewrite_eczemahaumon;?>">ECZEMA HẬU MÔN</a></h5></li>
            ...
            <div class="flex1col3">
                ...
                <div>
                    ...
                    <p><span class="text-uppercase"><strong>SỞ HỮU BẢN QUYỀN:</strong></span><i>phòng khám đa khoa Giải Phóng</i></p>
                </div>
            </div>
        </div>
    </div>
    <div class="container2">
        <div class="flex flex2 justify-content-between">
            ...
            <div class="flex2col1">
                ...
                <p>Liên hệ<br>bác sĩ</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg2"></div>
                <p>Kiểm tra<br>trước thủ thuật</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg3"></div>
                <p>Tư cách<br>bác sỹ</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg4"></div>
                <p>Vật tư<br>an toàn</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg5"></div>
                <p>Thiết bị<br>an toàn</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg6"></div>
                <p>Thủ thuật<br>an toàn</p>
                </a>
            </div>
            <div class="flex2col1">
                <a href="<?= link_tuvan;?>">
                <div class="bg bg7"></div>
                <p>Chăm sóc<br>sau thủ thuật</p>
                </a>
            </div>
        </div>
    </div>
...
<?= popup();?>
<?= AddLeft();?>
<script src="http://trihanoi.com/public/js-s/slides.min.jquery.js"></script>
<script type="text/javascript" src="http://trihanoi.com/son/js/index.js"></script>
<script>
    $(document).ready(function(){
        $('.quypham ul li').hover(function(){
            $(".quypham ul li").removeClass('qp1');
            $(".quypham ul >div").removeClass('qp_kaka');
            $(this).next().addClass('qp_kaka');
            $(this).addClass('qp1');
        });
    });
</script>
<script type = "text/javascript" language = "javascript">
    $(document).ready(function() {
        $('.main1-l2 li a').hover(function(){
            $('.main1-l2 li a').addClass('an_an');
            $('.main1-l2 li a').removeClass('view_view');
            $(this).addClass('view_view');
        });
    });
</script>
