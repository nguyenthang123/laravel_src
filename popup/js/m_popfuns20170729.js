...
function popphongkham168_com(){
    var str='<style>'+
        '.tu-van-dien-thoai a p {float: left;margin: 0px;padding: 5px 23px;border-radius: 5px;text-align: center;}'+
        '.tu-van-dien-thoai a{color:#fff;   text-decoration: none;  font-size: 14px;cursor: pointer;}'+
    '</style>';
