                ...
                <?php foreach($cate[$key]['lv2'] as $keylv2=>$vallv2){?>
                    <li class="stt">
                        <div class="menu_tit">
                            ...
                            <a href="<?php echo domain.'/admin/categories/del/'.$vallv2['id'];?>" onclick="if(!confirm('Bạn có muốn xóa?')) return false;"><i class="icon-remove"></i></a>
                            ...
                            <?php foreach($cate[$key]['lv2'][$keylv2]['lv3'] as $keylv3 =>$vallv3){?>
                                <li class="stt">
                                    <div class="menu_tit">
                                        ...
                                        <a href="<?php echo domain.'/admin/categories/del/'.$vallv3['id'];?>" onclick="if(!confirm('Bạn có muốn xóa?')) return false;"><i class="icon-remove"></i></a>
