            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                        ...
                        <label>Họ tên bênh nhân</label>
                        {!! Form::text('vosinh_tinvui_hoten',null,array( 'class' => 'input-xlarge form-control')) !!}
                        <label>Nghề nghiệp</label>
                        {!! Form::text('vosinh_tinvui_nghenghiep',null,array( 'class' => 'input-xlarge form-control')) !!}
                        <label>Tuổi:</label>
                        {!! Form::text('vosinh_tinvui_tuoi',null,array( 'class' => 'input-xlarge form-control')) !!}
                        <label>Tóm tắt</label>
                        ...
                        <!--<label>
                            ...
                            <span class="abc">Điều trị thành công :    <?php /*echo Form::checkbox('new_dieutrithanhcong', '1', true);*/?></span>
                        </label>-->
                        <label>
                            <span class="abc">Hot :    <?php echo Form::checkbox('new_hot', '1', false);?></span>
                            <span class="abc">Điều trị thành công :    <?php echo Form::checkbox('new_dieutrithanhcong', '1', true);?></span>
