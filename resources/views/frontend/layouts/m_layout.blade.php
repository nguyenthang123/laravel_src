...
<div class="page">
    ...
    function banner_tet(){
        ...
        $url = 'http://phongkhamgiaiphong.com/banner_tet/index.php?device=mobile&domain='.$domain;
        $ch = curl_init($url);
        ...
        <div class="banner">
            <div id="carousel-id" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="item active" style="<?= $BannerTet['css'];?>">
                        <a href="<?= link_tuvan;?>"><img style="height: 175px;width: 100%;" alt="Second slide" src="<?= $BannerTet['img'];?>"></a>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        <a href="<?=link_tuvan;?>"><img style="height: 175px;width: 100%;" alt="Third slide" src="/public/mobile/images_t/banner.png"></a>
                    </div>
                </div>
            ...
            <div id="carousel-id" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="item active">
                        <a href="http://phongkhamgiaiphong.com/mobile/cdsuckhoe/chuyen-muc-suc-khoe/"><img style="height: 175px;width: 100%;" alt="Second slide" src="http://phongkhamgiaiphong.com/cd/img/m_bn_nk.jpg"></a>
                    </div>
                    <div class="item">
                        <a href="<?=link_tuvan;?>"><img style="height: 175px;width: 100%;" alt="Third slide" src="/public/mobile/images_t/banner.png"></a>
                    </div>
