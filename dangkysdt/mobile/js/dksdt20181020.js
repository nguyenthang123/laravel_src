var str = '<link href="http://phongkhamviendong.vn/dangkysdt/mobile/css/dksdt.css" rel="stylesheet">';
...
if(arr1.indexOf(domain) >=0){
    var str = '<link href="http://phongkhamviendong.vn/dangkysdt/mobile/css/dksdt_footer.css" rel="stylesheet">';
}
if('phongkhamviendong.vn'== domain){
    var pathArray = window.location.pathname.split('/');
    var ArrCat=['nam-khoa','benh-tri','benh-xa-hoi'];
    if(ArrCat.indexOf(pathArray[1]) >=0){
        var str = '<link href="http://phongkhamviendong.vn/dangkysdt/mobile/css/dksdt_footer.css" rel="stylesheet">';
    }
}
