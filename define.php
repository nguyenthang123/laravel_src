...
define("link_zalo", "https://zalo.me/01663528899");
...
function facebook_chat(){
    $str='<style>#fb-root iframe{left: 9px!important;} .fb_dialog{left: 18px!important;}</style>';
    $str2='<!-- Load Facebook SDK for JavaScript -->
<div id="fb-root"></div>
