	...
	<section id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<div class="benh">
				<div class="row row1">
					<div class="tieu-de">
						<i class="fa fa-play-circle left" aria-hidden="true"></i><h2><a href="<?php echo get_category_link(2);?>"><?php echo get_cat_name(2);?></a></h2>
						<p class="right"><a href="<?= link_tuvan;?>">Tìm hiểu chi tiết</a></p>
					</div>
				</div>
			</div>
			<div class="table">
				<div class="tab-link">
					<table>
						<tr>
							<td class="active" data-tab-id="5"><?php echo get_cat_name(5);?></td>
							<td data-tab-id="6"><?php echo get_cat_name(6);?></td>
							<td data-tab-id="12"><?php echo get_cat_name(12);?></td>
							<td data-tab-id="9"><?php echo get_cat_name(9);?></td>
						</tr>
						<tr>
							<td data-tab-id="8"><?php echo get_cat_name(8);?></td>
							<td data-tab-id="7"><?php echo get_cat_name(7);?></td>
							<td data-tab-id="11"><?php echo get_cat_name(11);?></td>
						</tr>
					</table>
				</div>
			</div>
			<?php $benh = [5,6,12,9,8,7,11];?>
