...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/css/pagination.css">
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/css/archive-tab.css">
	<script>
...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="logo">
			<h1><a href="<?= rewrite_number_phone(phone1);?>"><img src="<?php echo get_template_directory_uri();?>/css/images/logo.png"></a></h1>
		</div>
	</header><!-- .site-header -->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 640px; height: 245px; overflow: hidden;">
            <div data-p="110.625" style="display: none;">
                <a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en" target="_blank">
                    <img data-u="image" src="<?php echo get_template_directory_uri();?>/css/images/banner-mobile3.png" />
                </a>
            </div>
            <div data-p="110.625" style="display: none;">
