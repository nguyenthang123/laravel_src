<?php get_header('chuyende'); ?>
	...
	<div class="top-banner">
		<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en"><img src="<?php echo get_template_directory_uri();?>/css/bangkiemtrasuckhoevetai/img/1.png"></a>
	</div>
	<div class="kiemtra">
		<div class="container">
			<div class="luuy">
				<h1>BẢNG KIỂM TRA SỨC KHỎE BỆNH VỀ TAI</h1>
				<p>Giới thiệu về bảng kiểm tra: Tai là 1 cơ quan quan trọng của cơ thể, liệu họng của bạn có tiềm ẩn bệnh tật không?</p>
			...
			<div class="question">
				...
				<form action="" method="post">
					<div class="item flex">
						<div class="col1">
							<p>Bạn có thường xuyên ngoáy tai không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Bạn có cảm thấy thính lực đang giảm dần không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Bạn có thường xuyên thấy ù ù trong tai không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Tai bạn có từng bị thương không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Trong tai bạn có hiện tượng chảy mủ không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Bạn có thường xuyên uống thuốc kháng sinh không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Khi nói chuyện với người khác, bạn có cần người đối diện phải 
								nhắc lại vài lần hoặc ghé sát lại và nói to bạn mới có thể nghe 
								thấy hay không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Khi lắc đầu, bạn có nghe thấy tiếng nước chảy không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Khi nằm xuống bạn có thường nghe thấy tiếng tim đập không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Bạn có cảm thấy đau âm ỉ hoặc đôi khi đau nhói trong tai hay không?</p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Vào ban đêm bạn có thấy tiếng vang lớn trong tai, tâm trạng cáu bẳn, khó ngủ không?  </p>
					...
					<div class="item flex">
						<div class="col1">
							<p>Bạn có tình trạng chóng mặt, đổ mồ hôi lạnh, sắc mặt tái nhợt không?</p>
	...
	<div class="popup9_khoemanh popup9" id="popup9_khoemanh">
		...
		<p class="kiemtra3">
			<span>Chúc mừng bạn!</span> Kết quả của hệ thống tự kiểm tra triệu chứng bệnh ở tai cho 
			thấy, tai của bạn rất khỏe mạnh, điều này có liên quan chặt chẽ với những thói 
			quen sinh hoạt tốt mà bạn đã duy trì trong thời gian dài, vùng tai khỏe mạnh 
	...
	<div class="popup9_binhthuong popup9" id="popup9_binhthuong">
		...
		<p class="kiemtra2">Kết quả kiểm tra của bạn đã có rồi !</p>
		<p class="kiemtra3">
			<span>Hãy chú ý !</span> Kết quả của hệ thống tự kiểm tra triệu chứng bệnh ở tai cho 
			thấy, tai của bạn đang có vấn đề, thường ngày nên tạo được thói quen 
			sinh hoạt tốt, chú ý giữ gìn vùng tai luôn khỏe mạnh, khi thấy khó chịu 
	...
	<div class="popup9_nghiemtrong popup9" id="popup9_nghiemtrong">
		...
		<p class="kiemtra2">Kết quả kiểm tra của bạn đã có rồi !</p>
		<p class="kiemtra3">
			<span>Rất tiếc! </span>  Kết quả của hệ thống tự kiểm tra triệu chứng bệnh ở tai cho 
			thấy, tai của bạn đang có vấn đề, thường ngày nên tạo được thói quen 
			sinh hoạt tốt, chú ý giữ gìn vùng tai luôn khỏe mạnh, khi thấy khó chịu 
			cần kịp thời đến cơ sở y tế để kiểm tra, tích cực phòng tránh các bệnh 
			về tai. 
