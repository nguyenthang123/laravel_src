...
<?= cdtop();?>
    <div class='out1'>
      ...
      <div id='slider' class='owl-carousel owl-theme clear'>
          <div class='item'>
              <a href="<?= link_tuvan;?>">
                  <img src="http://taimuihonghanoi.net/wp-content/themes/168mauxanh/images/slide0.jpg" />
              </a>
          </div>
        <div class='item'>
            <a href="<?= link_tuvan;?>">
                <img src="http://taimuihonghanoi.net/wp-content/themes/168mauxanh/images/slide1.jpg" />
            </a>
        </div>
    </div>
