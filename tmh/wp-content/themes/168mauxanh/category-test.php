				...
				<div class="left main-content">
					...
					<div class="clearfix">
						<div class="left img-cat-parent">
							<?php if($cat == 2):?>
								<a href=""><img src="<?php echo get_template_directory_uri();?>/images/cat-parent-img.png"></a>
							<?php elseif( $cat == 3):?>
								<a href=""><img src="<?php echo get_template_directory_uri();?>/images/cat-parent-benh-tai.png"></a>
							<?php elseif ($cat == 4):?>
								<a href=""><img src="<?php echo get_template_directory_uri();?>/images/cat-parent-benh-hong.png"></a>
							<?php endif;?>
						</div>
							...
							<?php if($cat == 2):?>
								<div class="clearfix">
									<div class="left left-1">
										<a class="active" href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Viêm mũi có thể điều trị triệt để không? Cách chữa ra sao?</a>
									</div>
									<div class="left left-2">
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Nguyên nhân gây xuất huyết mũi là gì?.</a>
										</div>
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Viêm mũi dị ứng có thể trị tận gốc không?</a>
										</div>
									</div>
								</div>
								<div class="clearfix">
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Viêm xoang ở trẻ nhỏ gây những tác hại gì?</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Chữa trị polyp mũi như thế nào?</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Phì đại cuốn mũi có thể chữa khỏi không?</a>
									</div>
								</div>
							<?php endif;?>
							<?php if($cat == 3):?>
								<div class="clearfix">
									<div class="left left-1">
										<a class="active" href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Điếc tai có thể chữa khỏi không? Cách chữa thế nào?</a>
									</div>
									<div class="left left-2">
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Tác hại của ù tai là gì?</a>
										</div>
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Làm sao để điều trị triệt để bệnh ù tai?</a>
										</div>
									</div>
								</div>
								<div class="clearfix">
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Phải làm gì khi mắc viêm tai ngoài?</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Phương pháp trị viêm tai giữa tốt nhất</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Nguyên nhân gây ù tai là gì?</a>
									</div>
								</div>
							<?php endif;?>
							<?php if($cat == 4):?>
								<div class="clearfix">
									<div class="left left-1">
										<a class="active" href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en" style="padding-top: 15px;">Viêm amidan có thể chữa khỏi triệt để không? Phải chữa thế nào?</a>
									</div>
									<div class="left left-2">
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Viêm họng có những triệu chứng gì?</a>
										</div>
										<div>
											<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Chi phí điều trị viêm họng</a>
										</div>
									</div>
								</div>
								<div class="clearfix">
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Làm thế nào điều trị tận gốc viêm họng</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Họng vừa khô rát vừa đau là làm sao?</a>
									</div>
									<div class="left left-3">
										<a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Phải làm gì khi bị viêm hầu họng?</a>
									</div>
								</div>
							<?php endif;?>
						</div>
					...
					<div class="list-trieu-trung clearfix">
						...
						<div class="left">
							...
							<a title="Gặp tư vấn trực tiếp 7h-22h" href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">Bệnh viện</a>
						</div>
						<div class="left">
					...
					<div class="tabs-content">
						<?php 
							...
							<?php
								$args = array( 'posts_per_page' => 6, 'offset'=> 0, 'category' => $category->term_id );
										...
										<div class="left article">
											...
											if($mark == 1):?>
												...
												<p class="description">
													...
													<a class="view-more" href="<?php the_permalink(); ?>">[Chi tiết]</a>
												</p>	
												<?php 
											endif;
											if($mark > 1):?>
					...
					<div class="kien-thuc-ve-benh clearfix">
						...
						<span class="txt">6 ưu điểm lớn của bệnh viện</span> 
						<span class="soc-ngang"></span>
					</div>
					<div class="uu-diem">
						<div class="clearfix">
