...
$(function() {
	...
	str += '.float_container .ntitle .icon_swt{ position: absolute; z-index: 1003; left: 10px; top: 0; }';
	...
	str += '<div class="ntitle"><img class="icon_swt" src="http://dadayhn.com/wp-content/themes/168mauxanh/images/logo_footer.png" width="43" height="39"><span></span>TRUNG TÂM TƯ VẤN TRỰC TUYẾN KHOA TAI MŨI HỌNG<img class="close_swt" src="http://dadayhn.com/wp-content/themes/168mauxanh/chat/images/closeBtn_swt.png" width="30" height="30" ntitle="关闭"></div>';
	str += '<dl class="cf" id="tools2" style="display: block;">';
	str += '<dt><img src="http://dadayhn.com/wp-content/themes/168mauxanh/chat/images/zjtouxiang.jpg"></dt>';
	str += '<dd>';
	str += '<div class="time1" id="now1"></div>';
	str += '<a style="text-decoration: none;" href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">';
	str += '<div class="box11"><img alt="smile" src="http://dadayhn.com/wp-content/themes/168mauxanh/chat/images/smile.gif">Chào bạn, hôm nay đến ca trực của tôi, tôi có thể giúp gì được bạn?</div>';
	str += '</a>';
	str += '</dd>';
	str += '</dl>';
	...
	str += '</dd>';
	str += '</dl>';		
	str += '<div class="sbtn cf"><a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en">TƯ VẤN ĐẶT HẸN</a><a href="http://swt.pk709.com/LR/Chatpre.aspx?id=KTF27288478&lng=en" class="a-jg">LẬP TỨC TRẢ LỜI</a></div>';
	str += '</div>';
