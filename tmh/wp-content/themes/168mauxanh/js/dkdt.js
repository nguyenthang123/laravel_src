document.writeln("<style>" +
    ...
    ".dangkysdt:hover .fp-ph-img-circle{background: #baf5a7 url(http://dadayhn.com/ico_dienthoai.gif) no-repeat center center;background-size: 70%;}" +
...
var str_html='<div class="dangkysdt" id="dangkysdt">' +
    ...
    var str_html2='<div id="popup_dangkysdt">' +
        ...
        '<button type="button" class="popup_dangkysdt_dangky">Click để được gọi lại'+'</button><p style="text-align:center;margin-top:15px;font-size:16px;">Trực tiếp gọi tới số : <a href="tel:043 - 393 8899"><strong style="font-weight:bold;">043 - 393 8899</strong></a> hoặc <a href="tel:0168 - 352 8899"><strong style="font-weight:bold;">0168 - 352 8899</strong></a>   sẽ càng thuận tiện hơn !</p>' +
'</div></div>';
        ...
        $(".popup_dangkysdt_dangky").on("click", function (e) {
            ...
            return false;
                ...
                if(checkmobile==0){
                    ...
                    var url = 'http://dadayhn.com/wp-content/themes/168mauxanh/goilaisodienthoai.php';
                    /* Send the data using post */
                    $.post(url,{s:dienthoai}, function(data, status){
