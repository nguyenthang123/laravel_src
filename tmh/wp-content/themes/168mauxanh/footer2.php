	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="container clearfix">
			<div class="left">
				<a href="<?= link_tuvan;?>"><img src="<?php echo get_template_directory_uri();?>/images/footer-icon.png"></a>
			</div>
			<div class="left footer-icon-face">
				<a href="<?= link_facebook;?>"><img src="<?php echo get_template_directory_uri();?>/images/footer-icon-face.png"></a>
			</div>
			<div class="left footer-icon-skype">
				<a href="<?= link_skype;?>"><img src="<?php echo get_template_directory_uri();?>/images/footer-icon-skype.png"></a>
			</div>
		</div>
		<div class="site-info">
			<div class="container clearfix">
				...
				<div class="left address">
					<h2>số điện thoại 
						...
						<a title="Gặp tư vấn trực tiếp 7h30-22h" href="tel:0978074181"><?= phone2;?></a>
					</h2>
					<h3>
...
<script type="text/javascript" defer src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/jquery.form.min.js"></script>
...
<script type="text/javascript" defer src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/bootstrap.min.js"></script>
<script type="text/javascript" defer src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/datetimepicker/build/jquery.datetimepicker.full.min.js"></script>
