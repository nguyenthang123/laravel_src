...
$(document).ready(function(){
    $(".nav2_box").mouseover(function(){
        $(".nav2_box").stop().animate({"width":"180px"},{easing: 'easeOutQuad',duration:200});
        $(".nav2_box").find(".tit").stop().animate({"width":"180px"},{easing: 'easeOutQuad',duration:200});
        $(this).stop().animate({"width":"460px"});
        $(this).find(".tit").stop().animate({"width":"180px"},{easing: 'easeOutQuad',duration:200});
    });
    slides();
    /*hot_box*/
    var _hotIndex=0;
    $('.main_item1 .hot_box .hot_tab li').mouseover(function(){
        ...
        $(this).addClass("hover");
        $('.main_item1 .hot_box .hot_con li').css({"display":"none"});
    ...
    $('.vandethuonggap .ks_tab li').mouseover(function(){
        ...
        $(this).addClass("hover");
        $('.vandethuonggap .ks_content li').css({"display":"none"});
    ...
    $('#index_hj .left dl dd').mouseover(function(){
        ...
        $(this).addClass("hover");
        $('#index_hj .right dl').css({"display":"none"});
...
function tab_vandethuonggap(key){
    $(key+' .ks_list2 a').hover(function(){
        ...
        $(key+' .tab_content').eq(_index2).css({"display":"block","opacity":"1"});
    })
}
...
function showtab(key,key2){
    $('.'+key).hover(function(){
        var i=$(this).attr('data-i');
        $('.'+key).removeClass('hover');
        $('.'+key2).removeClass('hover');
        $(this).addClass('hover');
        console.log(i);
        $('.'+i+'_content').addClass('hover');
    })
}
function slides(){
    var index=0;
...
function tuvantrongthang(){
    ...
    var today= d.getDate();
    var member=100;
    var arr=[210,220,230,240,250,260,270,280,290,200,210,220,230,240,550,660,470,480,490,500,310,320,330,440,55,66,37,38,39,30,31];
...
function henkhamtrongthang(){
    ...
    var today= d.getDate();
    var member=100;
    var arr=[110,120,230,240,150,160,170,180,190,200,210,220,230,240,250,260,270,280,290,100,110,220,230,240,250,160,170,180,190,200,110];
    for(var i=0;i< today;i++){
        member=member+arr[i];
    }
    if(member > 1000){
...
function zxNo(){
    ...
    function changeNo(no,id,len){
        ...
        for(var i=1;i<=len;i++){
            n=no.substr(i-1,1);
            //them 1 div vao cuoi
            id.eq(i-1).append('<div class="nopic" style="background:url(/bxh/public/frontend/img/home/num_'+n+'.png); top:49px;"></div>');
            //an cai div dau
