...
function bannersOpiton($cate=null,$img=null,$style=null){
    ...
    if($cate=='home'){
        ...
        if(empty($img)){
            $img='/public/frontend/images/home/banner.jpg';
            $img2= '/public/frontend/images/home/banner3.jpg';
            $style='background:#ffffff;';
            $style2 = 'background:#a0d9f4;';
            $style3 = 'padding: 0px; margin: 0px; list-style: none; font-size: 0px;width:71%;top:52px;';
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <div class="bg_ban_item1" style="'.$style.'">
                        <div class="ban_item">
                            <a href="">
                                <img src="'.domain.$img2.'" alt="kham phu khoa">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    $str='<form name="frmdkk" id="frmdkk" method="post" target="_self">
        ...
        <div class="dangkykham box_bodder">
                    ...
                    <ul>
                        ...
                        <li class="">
                            <div>
                                <input type="button" class="btn-success" style="background: #39bbd1;width:257px;" name="dangkykham" id="dangkykham" value="Đăng ký trực tuyến">
                            </div>
                            <div class="" style="margin-top: 10px;">
                                <input type="reset" class="btn-success" style="width:257px;margin-top:10px;" name="nhaplai" value="Nhập lại">
                            </div>
                        </li>
                    </ul>
                </div>
