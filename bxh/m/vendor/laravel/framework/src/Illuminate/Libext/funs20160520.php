...
class funs{
    public function breadcum($arr){
        $str='<img src="'.domain.'/public/frontend/img/noi-tiet-to-nu/ico_trangchu.png"> <a href="'.domain.'"> Trang chủ </a>';
        $link=domain;
        foreach($arr as $val){
    ...
    public function uploadFile($url,$files,$filesize,$allowType){
        $fName		=$files['name'];
    ...
    public function substr_font($str,$number){
