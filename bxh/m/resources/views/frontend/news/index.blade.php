...
<div class="main_content">
    ...
    <div class="main_item articel">
        <div class="nguyennhan">
            <div class="tit"><a href="<?= link_to($cate['cat_rewrite'],new_nguyennhan)?>">Nguyên nhân</a></div>
            <ul class="articel">
        ...
        <div class="nguyennhan">
            <div class="tit"><a href="<?= link_to($cate['cat_rewrite'],new_trieuchung)?>">Triệu chứng</a></div>
            <ul class="articel">
        ...
        <div class="nguyennhan">
            <div class="tit"><a href="<?= link_to($cate['cat_rewrite'],new_nguyhai)?>">Nguy hại</a></div>
            <ul class="articel">
        ...
        <div class="nguyennhan">
            <div class="tit"><a href="<?= link_to($cate['cat_rewrite'],new_dieutri)?>">Điều trị</a></div>
            <ul class="articel">
        ...
        <div class="nguyennhan">
            <div class="tit"><a href="<?= link_to($cate['cat_rewrite'],new_chiphi)?>">Chi phí</a></div>
            <ul class="articel">
