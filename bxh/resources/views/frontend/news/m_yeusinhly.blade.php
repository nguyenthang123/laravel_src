...
<div class="main_content">
    ...
    <style>
        .nguyennhan .tit{background: url("<?= fixk;?>/public/mobile/imgs/ico_nguyennhan.png") no-repeat left center;}
        .trieuchung .tit{background: url("<?= fixk;?>/public/mobile/imgs/ico_trieuchung.png") no-repeat left center;}
        .nguyhai .tit{background: url("<?= fixk;?>/public/mobile/imgs/ico_nguyhai.png") no-repeat left center;}
        .dieutri .tit{background: url("<?= fixk;?>/public/mobile/imgs/ico_dieutri.png") no-repeat left center;}
        .chiphi .tit{background: url("<?= fixk;?>/public/mobile/imgs/ico_chiphi.png") no-repeat left center;}
        .nguyennhan .tit{
    ...
    <div class="main_item main_tit2"><?= $cate['cat_name'];?>
        <a href="<?= link_tuvan;?>">click tư vấn <img src="/public/mobile/imgs/ico_tit_muiten.png" alt="tu van"></a>
    </div>
