...
@section('content')
<link href="<?= fixk;?>/public/frontend/css/tien-liet-tuyen.css" rel="stylesheet">
<div class="row">
    <?= bannersOpiton(rewrite_munropsinhduc,'','background:#f4f4f6;');?>
</div>
<div class="row tien_liet_tuyen">
    ...
    <div class="main_item">
        <div class="cha_zxbtn">
            ...
            <div class="right"><a href="" ><img src="<?= fixk;?>/public/frontend/images/mun-rop-sinh-duc/banner_mrsd.jpg"></a></div>
        </div>
