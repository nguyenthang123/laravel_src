...
@section('content')
    ...
    <div class="main_item hangmuc">
        <div class="hangmuc_item">
            <a href="/<?= rewrite_suimaoga;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_smg.png" alt="sui mao ga">
                <p>Sùi mào gà</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="<?= rewrite_suimaoganam;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_smg_nam.png" alt="sui mao ga nam gioi">
                <p>Sùi mào gà nam giới</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="<?= rewrite_suimaoganu;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_smg_nu.png" alt="sui mao ga nu">
                <p style="letter-spacing: -0.5px;">Sùi mào gà nữ giới</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= rewrite_benhlau;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_bl.png" alt="benh lau">
                <p>Bệnh lậu</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= rewrite_giangmai;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_gm.png" alt="giang mai">
                <p style="letter-spacing: -0.5px;">Bệnh giang mai</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= rewrite_munropsinhduc;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_herpes.png" alt="herpes sinh duc">
                <p>Herpes sinh dục</p>
            </a>
        </div>
    </div>
    ...
    <div class="clear2"></div>
    <?php if(!empty($news_truonghopkhoibenh)){?>
    <div class="main_tit">
