...
//DANHMUC
Route::any('/sui-mao-ga','Frontend\NewsController@suimaoga');
Route::any('/benh-lau','Frontend\NewsController@benhlau');
Route::any('/benh-giang-mai','Frontend\NewsController@giangmai');
Route::any('/mun-rop-sinh-duc','Frontend\NewsController@munropsinhduc');
