            ...
            <div class="well">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['created_at']));?></td>
                        <td style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['updated_at']));?></td>
                        <td style="text-align: center;"><?php echo $val['adm_update'];?></td>
                        <td>
