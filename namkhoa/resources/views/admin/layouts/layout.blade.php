...
<div class="sidebar-nav">
    ...
    <a href="#vosinh" class="nav-header collapsed" data-toggle="collapse"><i class="icon-exclamation-sign"></i>Vô sinh-Điều trị thành công<i class="icon-chevron-up"></i></a>
