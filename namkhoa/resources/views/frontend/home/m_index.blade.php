    ...
    <div class="main_item hangmuc">
        <div class="hangmuc_item">
            <a href="/<?= cat_rewrite_yeusinhly;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_ysl.png" alt="yeu sinh ly">
                <p>yếu sinh lý</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= cat_rewrite_chinhhinh;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_vntt.png" alt="tien liet tuyen">
                <p>Chỉnh hình cơ quan sinh dục</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= cat_rewrite_tienliettuyen;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_tlt.png" alt="viem nhiem tiet nieu">
                <p style="letter-spacing: -0.5px;">Bệnh tiền liệt tuyến</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= cat_rewrite_nhiemtrung;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_blbqd.png" alt="benh ly bao quy dau">
                <p>Nhiễm trùng đường tiết niệu</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="/<?= cat_rewrite_vosinh;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_vsn.png" alt="vo sinh nam">
                <p style="letter-spacing: -0.5px;">Vô sinh nam</p>
            </a>
        </div>
        <div class="hangmuc_item">
            <a href="<?= link_tuvan;?>">
                <img src="<?= fixk;?>/public/mobile/imgs/ico_hm_blk.png" alt="cach benh ly khac">
