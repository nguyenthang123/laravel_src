...
<div class="row" style="height: 110px;">
    <div class="main_item main_item1" style="width: 100%">
        <div style="position: absolute;margin-top: -80px;background: url('/public/frontend/images/home/toolbar_bg.png')repeat-x;width: 100%;">
            <div class="nav2">
                <div class="nav2_in">
                    <div class="nav2_box">
                        <div class="con">
