...
<head>
    ...
    <meta property="og:url" itemprop="url" content="http://khamnamkhoahanoi.vn/" />
    <link rel="stylesheet" href="http://khamnamkhoahanoi.vn/public/mobile/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://khamnamkhoahanoi.vn/public/mobile/css/style.css">
    <link rel="stylesheet" href="http://khamnamkhoahanoi.vn/public/mobile/css/custorm.css">
    <link rel="stylesheet" href="http://khamnamkhoahanoi.vn/public/mobile/css/menu.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    <script src="/public/mobile/bootstrap/js/bootstrap.min.js"></script>
    <?= ico_shortcut;?>
    <base target="_blank">
</head>
<?php
...
<div class="menu_main" style="display: none">
    <div class="menu_main_left">
        <img src="/public/mobile/menu_images/bg_lv1.png" style="width: 100%;float: left;">
        <ul class="lv1">
...
<div class="main_item info">
    ...
    <p><img src="/public/mobile/imgs/ico_f_diachi.png" alt="dia chi"> Số 709 - Giải Phóng - Hoàng Mai - Hà Nội</p>
    <p><img src="/public/mobile/imgs/ico_f_dienthoai.png" alt="dien thoai"> 0432.969.666 (miễn phí) – 0166.352.8899 - 096 5215 398</p>
    <p>Sở hữu bản quyền: phòng khám đa khoa Giải Phóng Hà Nội</p>
</div>
<div class="footer" style="position: fixed;bottom: 0px;float: left">
    <div class="footer_item">
        <a href="<?= domain;?>">
            <img src="/public/mobile/imgs/ico_footer_home.png" alt="trang chủ">
            <p>Trở về<br>Trang chủ</p>
        </a>
    </div>
    <div class="footer_item">
        <a href="<?= link_tuvan;?>">
            <img src="/public/mobile/imgs/ico_footer_tv.png" alt="tư vấn">
            <p>Tư vấn<br>trực tuyến</p>
        </a>
    </div>
    <div class="footer_item">
        <a href="<?= rewrite_number_phone(phone1);?>">
            <img src="/public/mobile/imgs/img_footer_dt.png" alt="dien thoai">
        </a>
    </div>
    <div class="footer_item">
        <a href="<?= link_tuvan;?>">
            <img src="/public/mobile/imgs/ico_footer_dk.png" alt="dang ky">
            <p>Đăng ký<br>qua mạng</p>
        </a>
    </div>
    <div class="footer_item">
        <a href="<?= link_mobile_diachi;?>">
            <img src="/public/mobile/imgs/ico_footer_dc.png" alt="tuyen duong">
            <p>Tuyến đường</p>
        </a>
    </div>
</div>
