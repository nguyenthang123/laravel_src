    ...
    <div id="banners">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="bg_ban_item1" style="background:#e9f7fa;">
                        <div class="ban_item">
                            <a href="">
                                <img src="<?= domain;?>/public/frontend/images/quy-trinh-kham/banner.jpg" alt="kham phu khoa nhan ai">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="main_item" style="height: 40px;margin-top: -40px;">
            <div style="position: absolute;display: block;background: white;height: 40px;line-height: 40px;padding: 0 15px;min-width: 290px;">
                <a style="font-weight: 600;text-transform: uppercase;color: #000000;">Ưu thế phòng khám</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="main_item">
        <div class="cha_list">
            ...
            <div class="right" style="border: 1px solid #ccc;">
                <div class="tit">
                    <span>
                            <a href="<?= domain;?>">Trang chủ</a> / <?= $cate['cat_name'];?>
                    </span>
                </div>
                ...
                <div class="col-lg-12 list_bv">
                    <div class="col-lg-12 boder_b">
                                ...
                                <tr>
                                    <td>
                                        <a href="/<?= $val['new_rewrite'];?>">
                                            <img src="<?= domain;?><?= $val['new_img'];?>" alt="<?= $val['new_name'];?>">
                                        </a>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="col-lg-8" style="padding-left: 0px;padding-right: 0px;">
                            <h3><a href="/<?= $val['new_rewrite'];?>"><?= substr_font($val['new_name'],75);?></a> </h3>
                            <div class="des">
