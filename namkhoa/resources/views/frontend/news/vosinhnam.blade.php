...
<div class="row">
    <?= bannersOpiton('vo-sinh-nam','/public/frontend/images/quy-trinh-kham/banner.jpg','background:#fafbfd;');?>
</div>
<div class="row tien_liet_tuyen">
    ...
    <div class="main_item hamuc_yeusinhly">
        <div class="cha_list">
            ...
            <div class="right">
                <div class="tit"><span>Hạng mục vô sinh</span></div>
                <div class="clists hover">
                    <dl>
                        <dt class="t">
                        <p><a href="/khong-tinh-trung" >Không tinh trùng</a></p>
                        <div class="pic"><a href="/khong-tinh-trung" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic59.jpg" height="109" width="114"></a></div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <div class="pic"><a href="/it-tinh-trung" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic60.jpg" height="109" width="114"></a></div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <div class="pic"><a href="/tinh-trung-chet" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic61.jpg" height="109" width="114"></a></div>
                        </dt>
                ...
                <div class="clists">
                    <dl>
                        ...
                        <div class="pic"><a href="/tinh-trung-yeu" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic62.jpg" height="109" width="114"></a></div>
                        </dt>
                ...
                <div class="clists">
                    <dl>
                        ...
                        <div class="pic"><a href="/vo-sinh-do-bat-thuong-chuc-nang-sinh-san" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic63.jpg" height="109" width="114"></a></div>
                        </dt>
                ...
                <div class="clists">
                    <dl>
                        ...
                        <div class="pic"><a href="/vo-sinh-do-bat-thuong-noi-tiet-to" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/cpic64.jpg" height="109" width="114"></a></div>
                        </dt>
    ...
    <div class="main_item">
        <div class="cha_zxbtn">
            ...
            <div class="right"><a href="" ><img src="<?= domain;?>/public/frontend/images/vo-sinh-nam/banner_vsn.jpg"></a></div>
        </div>
