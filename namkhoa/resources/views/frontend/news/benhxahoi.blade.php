...
<div class="row">
    <?= bannersOpiton('benh-xa-hoi','/public/frontend/images/quy-trinh-kham/banner.jpg','background:#e9f7fa;');?>
</div>
<div class="row tien_liet_tuyen">
    <div class="main_item">
        <div class="cha_jj box_bodder">
            <div class="txt" style="background:url(<?= domain;?>/public/frontend/img/tien-liet-tuyen/cico1_28.gif) no-repeat 20px 55px;">
                ...
                <p>
                    phòng khám đa khoa Giải Phóng Hà Nội nhập khẩu hàng loạt các thiết bị quốc tế như Mỹ, Đức, Nhật Bản; có thể nhanh chóng tìm ra nguyên nhân bệnh xã hội, phòng khám nhập khẩu kỹ thuật chẩn trị bệnh xã hội tiên tiến, điều này giúp cho phòng khám Giải Phóng có thể nhẹ nhàng đối phó với các bệnh xã hội, có thể tiến hành điều trị có hiệu quả đối với bệnh xã hội.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="right">
                ...
                <div class="clists hover">
                    <dl>
                        ...
                        <div class="pic"><a href="/sui-mao-ga" ><img src="<?= domain;?>/public/frontend/images/benh-xa-hoi/smg.jpg" height="109" width="114"></a></div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <div class="pic"><a href="/benh-lau" ><img src="<?= domain;?>/public/frontend/images/benh-xa-hoi/cpic73.jpg" height="109" width="114"></a></div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <div class="pic"><a href="/giang-mai" ><img src="<?= domain;?>/public/frontend/images/benh-xa-hoi/cpic75.jpg" height="109" width="114"></a></div>
                        </dt>
                    ...
                    <dl>
                        ...
                        <div class="pic"><a href="/herpes-sinh-duc" ><img src="<?= domain;?>/public/frontend/images/benh-xa-hoi/cpic77.jpg" height="109" width="114"></a></div>
                        </dt>
    ...
    <div class="main_item">
        <div class="cha_zxbtn">
            ...
            <div class="right"><a href="" ><img src="<?= domain;?>/public/frontend/images/benh-xa-hoi/banner_bxh.jpg"></a></div>
        </div>
