...
throw new SyntaxError("JSON.parse")})}(),window.bpaMonitor=window.bpaMonitor||{},bpaMonitor.instance=bpaMonitor.instance||0,!bpaMonitor.instance++){var ROOT="http://bpa.#",URL={POST_DATA:ROOT+"/bpa/bpa.gif",GET_TOKEN:ROOT+"/bpa/bpaId"},EVENT_SIZE=100
...
return base64Encoder(JSON.stringify(e))},bpaMonitor.getID=function(){return"cba2e641-389d-40dc-ab86-9ae93738bd40"},bpaMonitor.getBpaId=function(){return updateBpaId(),bpaMonitor.bpaId},bpaMonitor.pushEvent=function(e){var t=bpaMonitor.eventQueue.push(e)
