...
function zxNo(){
    ...
    function changeNo(no,id,len){
        ...
        for(var i=1;i<=len;i++){
            n=no.substr(i-1,1);
            //them 1 div vao cuoi
            id.eq(i-1).append('<div class="nopic" style="background:url(<?= domain;?>/public/frontend/img/home/num_'+n+'.png); top:49px;"></div>');
            //an cai div dau
...
$(document).ready(function (e) {
    ...
    $("#dangkykham").on("click", function (e) {
        ...
        if(hoten=="" || dienthoai==""){
            ...
            var link_dangky="http://phongkhamgiaiphong.com/dangky.php?data="+data;
