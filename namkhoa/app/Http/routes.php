...
//if(empty($_SESSION['ArrCate'])){
    $cate=DB::table('categories')->get();
    $ArrCate=array();
    $arrNotCate=array('yeu-sinh-ly','chinh-hinh-co-quan-sinh-duc','benh-tien-liet-tuyen','nhiem-trung-duong-tiet-nieu','vo-sinh-nam','viem-nieu-dao');
    foreach($cate as $val){
        if(!empty($val['cat_rewrite']) && !in_array($val['cat_rewrite'],$arrNotCate)){
...
Route::any('/ajaxs/rating', 'Frontend\AjaxsController@rating');
//CHUYEN DE
...
//DANHMUC
Route::any('/chinh-hinh-co-quan-sinh-duc','Frontend\NewsController@chinhhinhcoquansinhduc');
Route::any('/benh-tien-liet-tuyen','Frontend\NewsController@tienliettuyen');
Route::any('/yeu-sinh-ly','Frontend\NewsController@yeusinhly');
Route::any('/nhiem-trung-duong-tiet-nieu','Frontend\NewsController@nhiemtrungduongtietnieu');
Route::any('/viem-nieu-dao','Frontend\NewsController@viemnieudao');
Route::any('/vo-sinh-nam','Frontend\NewsController@vosinhnam');
Route::any('/benh-xa-hoi','Frontend\NewsController@benhxahoi');
...
Route::group(['prefix' => 'admin','namespace' => 'Admin'], function() {
    ...
    Route::any('/news/sua/{id?}/{date?}', 'NewsController@sua');
    //ABOUT
